...
c       Store cosmological parameters
	   write (30,'(a,f4.0,a,f5.2,a,f5.2,a,f4.2,a,f6.2,a,f4.2,a,f6.2)')
     +  '#Ho=',h,' km/s/Mpc; Omega=',omega,'; Omega_lambda=',omega_lambda,
     +  '; Age of universe at z=',z,':',tu/1.e9,
     +  ' Gyr; Distance Modulus at z=',z,':',dm
c       List of model parameters and predicted fluxes
	   write (30,'(7(a10),a12,a4,a500)')
     +  '#      fmu',   ! 1: fraction of Ld(tot) contributed by the diffuse ISM
     +  '  xi_C^ISM',   ! 2: contribution of cold dust to total ISM luminosity
     +  '    T_W^BC',   ! 3: temperature of warm dust in birth clouds
     +  '   T_C^ISM',   ! 4: temperature of cold dust in ISM
     +  ' xi_PAH^BC',   ! 5: contribution of PAH to total BC luminosity
     +  ' xi_MIR^BC',   ! 6: contribution of MIR continuum to total BC luminosity
     +  '   xi_W^BC',   ! 7: contribution of warm dust to total BC luminosity
     +  '       Mdust',  ! 8: total dust mass (in Msun)
     +  '    ',filter_header  !9--nfilt_use: model AB magnitudes at redshift z

c       ---------------------------------------------------------------------------       
c       Read .bin file (50000 models)
...
c       Store parameters + magnitudes of each model in output file
	...
	open (29,file=infile,status='old',form='unformatted')
        ...
        do imod=1,50000
              read (29,end=1) (irprop(i),i=1,8)
	      read (29) (irsed(i),i=1,niw)
                 call model_ab_color(z,wl,irsed,niw,nfilt_use,filt_id_use,mags)
c                write output file:
                 write (30,200) (irprop(i),i=1,8),(mags(i),i=1,nfilt_use)
200              format(0p7f10.3,1pe12.3,0p50f10.4)
        enddo
1       stop
	end
c       ===========================================================================
